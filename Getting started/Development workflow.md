Whenever you make a change to the plugin source code, you need to reload the plugin in Obsidian. You can reload the plugin by quitting Obsidian and starting it again, but that gets tiring quickly.
