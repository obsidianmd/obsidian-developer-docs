In this guide, you'll configure your plugin to use [React](https://reactjs.org/). It assumes that you already have a plugin with a [[Views|view]] that you want to convert to use React.
...
You can mount your React component on any `HTMLElement`, for example [[Status bar]] elements. Just make sure to clean up properly by calling `ReactDOM.unmountComponentAtNode()` when you're done.
