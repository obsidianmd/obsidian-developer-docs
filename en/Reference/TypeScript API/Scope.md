...
|  --- | --- | --- |
|  [`register(modifiers, key, func)`](Scope.register.md) |  | Add a keymap event handler to this scope. |
|  [`unregister(handler)`](Scope.unregister.md) |  | Remove an existing keymap event handler. |
