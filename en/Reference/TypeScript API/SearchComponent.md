...
```
**Extends:** [`AbstractTextComponent`](AbstractTextComponent.md)`<``HTMLInputElement``>`
...
|  --- | --- | --- | --- |
|  [`clearButtonEl`](SearchComponent.clearButtonEl.md) |  | <code>HTMLElement</code> |  |

## Methods

|  Method | Modifiers | Description |
|  --- | --- | --- |
|  [`onChanged()`](SearchComponent.onChanged.md) |  |  |
