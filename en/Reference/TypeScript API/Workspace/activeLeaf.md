...
> 
> The use of this field is discouraged. The recommended alternatives are: - If you need information about the current view, use . - If you need to open a new file or navigate a view, use [Workspace.getLeaf](obsidian.workspace.getleaf_1.md).
> 
