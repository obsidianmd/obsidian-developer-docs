...
[`EditorSuggest`](EditorSuggest.md) › [`onTrigger`](EditorSuggest.onTrigger.md)
...
|  --- | --- | --- |
|  <code>cursor</code> | [`EditorPosition`](EditorPosition.md) |  |
|  <code>editor</code> | [`Editor`](Editor.md) |  |
|  <code>file</code> | [`TFile`](TFile.md)<code> &#124; null</code> |  |

**Returns:**

[`EditorSuggestTriggerInfo`](EditorSuggestTriggerInfo.md)` | null`
