...
[`MarkdownRenderer`](MarkdownRenderer.md) › [`render`](MarkdownRenderer.render.md)
...
|  --- | --- | --- |
|  <code>app</code> | [`App`](App.md) | A reference to the app object |
...
|  <code>component</code> | [`Component`](Component.md) | A parent component to manage the lifecycle of the rendered child components. |
