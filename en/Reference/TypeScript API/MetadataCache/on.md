...
[`MetadataCache`](MetadataCache.md) › [`on`](MetadataCache.on.md)
...
|  <code>callback</code> | <code>(file: </code>[`TFile`](TFile.md)<code>, data: string, cache: </code>[`CachedMetadata`](CachedMetadata.md)<code>) =&gt; any</code> |  |
