---
aliases: "MetadataCache.on_1"
cssclasses: hide-title
---

<!-- Do not edit this file. It is automatically generated by API Documenter. -->

[`MetadataCache`](MetadataCache.md) › [`on`](MetadataCache.on_1.md)
...
|  <code>callback</code> | <code>(file: </code>[`TFile`](TFile.md)<code>, prevCache: </code>[`CachedMetadata`](CachedMetadata.md)<code> &#124; null) =&gt; any</code> |  |
