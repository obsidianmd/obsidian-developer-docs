...
[`FileManager`](FileManager.md) › [`processFrontMatter`](FileManager.processFrontMatter.md)
...
|  --- | --- | --- |
|  <code>file</code> | [`TFile`](TFile.md) | the file to be modified. Must be a markdown file. |
