---
alias: "obsidian.TextFileView.md"
cssClass: hide-title
---
...
|  --- | --- | --- |
|  [`(constructor)(leaf)`](obsidian.TextFileView.(constructor).md) |  | Constructs a new instance of the <code>TextFileView</code> class |

## Properties

|  Property | Modifiers | Type | Description |
|  --- | --- | --- | --- |
|  [`data`](obsidian.TextFileView.data.md) |  | <code>string</code> | In memory data |
|  [`requestSave`](obsidian.TextFileView.requestSave.md) |  | <code>() =&gt; void</code> | Debounced save in 2 seconds from now |
