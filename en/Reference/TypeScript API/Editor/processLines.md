...
[`Editor`](Editor.md) › [`processLines`](Editor.processLines.md)
...
|  <code>write</code> | <code>(line: number, lineText: string, value: T &#124; null) =&gt; </code>[`EditorChange`](EditorChange.md)<code> &#124; void</code> |  |
