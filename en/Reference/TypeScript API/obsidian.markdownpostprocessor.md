...
[Home](./index.md) &gt; [obsidian](./obsidian.md) &gt; [MarkdownPostProcessor](./obsidian.markdownpostprocessor.md)
...
|  --- | --- | --- | --- |
|  [sortOrder?](./obsidian.markdownpostprocessor.sortorder.md) |  | number | _(Optional)_ An optional integer sort order. Defaults to 0. Lower number runs before higher numbers. |
