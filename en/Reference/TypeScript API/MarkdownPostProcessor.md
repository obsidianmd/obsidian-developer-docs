...
|  --- | --- | --- | --- |
|  [`sortOrder?`](MarkdownPostProcessor.sortOrder.md) |  | <code>number</code> | _(Optional)_ An optional integer sort order. Defaults to 0. Lower number runs before higher numbers. |
