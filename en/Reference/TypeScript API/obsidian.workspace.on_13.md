...
[Home](./index.md) &gt; [obsidian](./obsidian.md) &gt; [Workspace](./obsidian.workspace.md) &gt; [on](./obsidian.workspace.on_13.md)
...
|  --- | --- | --- |
|  name | 'editor-drop' |  |
|  callback | (evt: DragEvent, editor: [Editor](./obsidian.editor.md)<!-- -->, info: [MarkdownView](./obsidian.markdownview.md) \| [MarkdownFileInfo](./obsidian.markdownfileinfo.md)<!-- -->) =&gt; any |  |
